...
function App() {
  ...
  const { conversation, setConversation, addMessage, clearConversation } =
  ...
  // Fetch history on mount only if conversation is empty
  useEffect(() => {
  ...
  // Fetch user info only once or when user.sub changes
  // In App.tsx, modify the useEffect for fetching user info
  ...
  const handleClear = async () => {
    ...
    if (userConfirmed) {
      try {
        ...
        clearConversation(); // Use store to clear conversation
        setImage(null);
        handleImage();
      } catch (error) {
      ...
      <div className="app-container">
        <div className="left-side">
          ...
          <div className="status">
            ...
            {/* Add loader here. need to modify for loading image */}
            {isImageLoading && (
        ...
        <div className="right-side">
          ...
          >
            ...
            {/* Add loading animation 3 dots here */}
